...
def emp_todo(employee_id):
    uurl = "https://jsonplaceholder.typicode.com/users/{}".format(employee_id)
    turl = "https://jsonplaceholder.typicode.com/todos?userId={}".format(employee_id)
    ...
    completed_tasks = [task for task in tdata if task["completed"]]
